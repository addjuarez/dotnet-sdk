...
namespace Dapr.Client.Test
{
    ...
    public class ConfigurationApiTest
    {
        ...
        public async Task GetConfigurationAsync_WithAllValues_ValidateRequest()
        {
            ...
            invokeResponse.Items.Add("testKey", new Autogenerated.ConfigurationItem()
            {
                Value = "testValue",
                Version = "v1"
            });
            ...
            domainResponse.Items.ContainsKey("testKey").Should().BeTrue();
            domainResponse.Items["testKey"].Value.Should().Be("testValue");
            domainResponse.Items["testKey"].Version.Should().Be("v1");
        }
