    ...
    public class DaprConfigurationStoreProviderTest
    {
        ...
        public async Task TestConfigurationStoreExtension_ProperlyStoresValues()
        {
            ...
            var httpClient = new TestHttpClient()
            {
                Handler = async (entry) =>
                {
                    var items = new Dictionary<string, ConfigurationItem>() {{ "testKey" , item }};
        ...
        private async Task SendResponseWithConfiguration(Dictionary<string, ConfigurationItem> items, TestHttpClient.Entry entry)
        {
            ...
            {
                configurationResponse.Items.Add(item.Key, new Autogenerated.ConfigurationItem() 
                {
        ...
        private async Task SendStreamingResponseWithConfiguration(List<ConfigurationItem> items, TestHttpClient.Entry entry)
        {
            ...
            foreach (var item in items)
            {
                streamResponse.Items.Add(item.Key, new Autogenerated.ConfigurationItem() 
                {
                    Value = item.Value,
